...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { : @discussion., content: @discussion.content, title: @discussion.title } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { : @discussion., content: @discussion.content, title: @discussion.title } }
